...
useEffect(()=>{
  ...
  return (
    ...
    >
      ...
      <svg  viewBox="2 2 24 24" className={`${isHovered && 'fill-primary'} w-6 min-[1120px]:w-8 `}><path d="M14 4.5a9.5 9.5 0 109.5 9.5A9.51 9.51 0 0014 4.5zM9.26 21.05v-2.17a3.37 3.37 0 013.36-3.36h2.74a3.37 3.37 0 013.36 3.36v2.19a8.47 8.47 0 01-9.48 0zM14 14.5a2.5 2.5 0 112.5-2.5 2.5 2.5 0 01-2.5 2.5zm5.73 5.76v-1.38a4.37 4.37 0 00-3.44-4.26A3.45 3.45 0 0017.5 12a3.5 3.5 0 00-7 0 3.45 3.45 0 001.21 2.62 4.37 4.37 0 00-3.44 4.26v1.38a8.5 8.5 0 1111.46 0z"></path></svg>

        <Text className=' hidden min-[1120px]:block'>{currentUser.isLoggedIn ? "Account" : "Sign In"}</Text>
      </Box>
      {isHovered && (
        <Box
          // left={-100}
        ...
        >
{ currentUser.email ?  <h1 className='text-2xl font-medium'>Welcome</h1>  :       <NavLink to={'/authentication'}>

        <button  className='bg-primary text-white p-3 rounded-3xl text-lg  w-60 '>Sing In</button>
        <p  className='text-primary underline hover:no-underline my-2'>Create an account</p>
          </NavLink>}
        <hr />
        <a href=''  className="flex my-4 hover:underline hover:text-primary hover:fill-primary">
        ...
        {currentUser.email && <button onClick={handleLogout}   className='text-primary undedrline'>Signout</button>}
        </Box>
      )}
    </Box>
<NavLink to={'/cart'}>
