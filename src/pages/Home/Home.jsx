    ...
    <div id="home">
      <section id="section1">
        ...
        {section1Data.map((element)=>(
          <div key={element.title} className="p-2 pb-8  hover:border  hover:border-black hover:bg-gray-200  rounded-lg min-w-[175px]">
      ...
      <section id="section2" className="p-2 px-4  min-[1120px]:px-10 ">
        <div className="p-2 rounded-lg hover:border  border-black hover:bg-slate-200">
        <a href="">
        ...
        <div className="">
          ...
          <div className="flex h-auto relative">
            ...
            <div>
            <a href="">
              <div className="my-4 p-2 rounded-lg hover:border  border-black hover:bg-slate-200">
            ...
            <a href="" >
              <div className="px-1 rounded-lg hover:border  border-black hover:bg-slate-200">
